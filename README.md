...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-af4ssiq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-af4ssiq.containers.anotherwebservice.com/
...
```
git clone git@github.com:stomasz/container-af4ssiq.git
cd container-af4ssiq
```
...
```
docker attach container-af4ssiq
```
